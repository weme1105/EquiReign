...
export default function HomeScreen() {
  ...
  return <SafeAreaView style={styles.screen}>
    <ScrollView contentContainerStyle={styles.content}>
      ...
      <Pressable accessibilityRole="button" onPress={() => router.push('/demo')} style={[styles.modeCard, styles.demoCard]} testID="variant-demo"><Text style={styles.modeCode}>TEST LAB</Text><Text style={styles.modeTitle}>特殊規則 Demo</Text><Text style={styles.modeMeta}>冰封 · 遺失 · 混合 · 雙色域，共 12 關</Text></Pressable>
...
const styles = StyleSheet.create({
  ...
  modeCard: { backgroundColor: '#211d38', borderColor: '#514a70', borderRadius: 16, borderWidth: 2, marginTop: 14, padding: 18 }, campaignCard: { borderColor: '#d6b870' }, demoCard: { borderColor: '#8fc9d8' }, disabledMode: { opacity: .45 }, modeCode: { color: '#777087', fontSize: 9, fontWeight: '800', letterSpacing: 2 }, modeTitle: { color: '#fffaf1', fontSize: 23, fontWeight: '900', marginTop: 4 }, modeMeta: { color: '#aaa4bc', fontSize: 12, marginTop: 5 },
